...
class TextStyles {
  static TextStyle roboto20Color00 = GoogleFonts.roboto(
    fontSize: 20,
  ...
  static TextStyle roboto12Color0D =
      GoogleFonts.roboto(fontSize: 12, color: const Color(0XFF488A0D));
  static TextStyle roboto14ColorFF = GoogleFonts.roboto(
    fontSize: 14,
    color: const Color(0XFFFFFFFF),
  );
  static TextStyle roboto14Color20 = GoogleFonts.roboto(
    fontSize: 14,
